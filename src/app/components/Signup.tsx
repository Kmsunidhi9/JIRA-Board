        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <div>
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-sm text-muted-foreground">
                  I agree to the{" "}
                  <a href="#" className="text-[#0747A6] hover:underline">
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-[#0747A6] hover:underline">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/login" className="text-[#0747A6] hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-2 border border-border rounded hover:bg-muted transition-colors">
